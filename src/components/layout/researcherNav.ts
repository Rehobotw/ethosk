 ...
 * cannot achieve that, because "Create New" lives at `/researcher/surveys/new` —
 * underneath "My Surveys" — so both would light up on the builder, and two
 * highlighted items tell the researcher nothing about where they are.
 */
